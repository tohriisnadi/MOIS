    ...
    Function AddVendorInvoice(customer As String, ContactPerson As String, Ref As String, Currency As String, rate As String, dateinput As String, TermOfPayment As String,
        ...
        Try
            ...
            For i As Integer = 0 To data.Rows.Count - 1
                Command.CommandText = "exec AddDetilsVendorInvoice '" & Guid.NewGuid.ToString & "','" & KodeMaster & "','" & data.Rows(i).Item(1) & "','" & data.Rows(i).Item(2) & "','" & data.Rows(i).Item(5) & "','" & data.Rows(i).Item(6) & "'," _
